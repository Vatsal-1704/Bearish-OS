...
// import ConTb from '../components/Pages/ContactCenter/ConTb';
import ConTb from '../components/Pages/ContactCenter/ConTb';
// import DataTable from '../components/Pages/ContactCenter/ConTm';
...
const Router = () => {
    ...
    return (<>
        <Routes>
            ...
            />
            <Route path="/cont" element={<ConTb />}></Route>
            {/* <Route path="/contM" element={<DataTable />}></Route> */}
         </Routes>
    </>)
}
