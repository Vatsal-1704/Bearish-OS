            ...
            <Stack className={classes.unReadMilMain}>
                <Stack direction={'row'} justifyContent={'space-between'} paddingRight={'10px'}>
                    ...
                    <Stack direction={'row'} gap={'30px'}>
                        <img alt={''} style={{width: '8px', cursor: 'pointer'}} src={leftIcon}/>
                        <img  alt={''} style={{width: '8px', cursor: 'pointer'}} src={rightIcon}/>
                    </Stack>
                </Stack>
                            ...
                            <>
                                <Stack key={i} className={classes.emailContent}>
                                    <Stack direction={'row'} justifyContent={'space-between'}>
                                        ...
                                        <img alt={''} style={{width: '5px', cursor: 'pointer'}} src={moreIcon}/>
                                    </Stack>
